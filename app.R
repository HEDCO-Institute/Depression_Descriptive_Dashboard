...
# Helper function to classify grade levels into K-12 groupings per knowledge mobilization team
...
grades_match_filter <- function(processed_grades, selected_grades) {
  ...
  any(study_grades %in% selected_grades)
}
